...
class HousesControllerTest < ActionController::TestCase
  ...
  test "should create house" do
    assert_difference('House.count') do
      post :create, house: { description: @house.description, image: @house.image, name: @house.name }
    end
  ...
  test "should update house" do
    patch :update, id: @house, house: { description: @house.description, image: @house.image, name: @house.name }
    assert_redirected_to house_path(assigns(:house))
  end
